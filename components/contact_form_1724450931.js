<template>
  <main class="flex justify-center align-center p-10">
    <div class="w-fit max-w-lg p-8 bg-white shadow-lg rounded-lg">
      <div>
        <h3 class="text-black font-semibold text-xl">Get in Touch with TP Connect</h3>
        <p class="mt-3 text-black w-fit">Have a question or need assistance? We're here to help you with all your toilet paper needs!</p>
      </div>
      <form @submit.prevent class="space-y-5 mt-5">
        ...
        <div>
          <label class="font-medium text-black">Preferred Roll Type</label>
        ...
        <div>
          <label class="font-medium text-black">Quantity Needed</label>
          <textarea
            required
