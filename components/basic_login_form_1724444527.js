    ...
    <div class="p-10 flex flex-col items-center justify-center bg-white w-full max-w-md shadow-lg">
      <div class="text-black w-full">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-5 w-full">
          ...
          <button class="w-full px-4 py-2 text-white font-medium bg-green-600 hover:bg-green-500 active:bg-green-600 rounded-lg duration-150 mb-2">Sign in</button>
          <button class="w-full px-4 py-2 text-white font-medium bg-blue-600 hover:bg-blue-500 active:bg-blue-600 rounded-lg duration-150">Hadoken</button>
...
<script>
// This component represents a basic login form with email and password inputs.
export default {
  data() {
    return {
      expanded: false,
