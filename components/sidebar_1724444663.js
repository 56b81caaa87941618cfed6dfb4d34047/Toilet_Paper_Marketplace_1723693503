<template>
  <!-- Sidebar component with navigation and footer sections -->
        ...
        <div>
          ...
          <div class="py-4 px-4 w-fit border-t border-black">
            <div class="flex items-center gap-x-4">
              <div>
                <span class="block text-white-700 text-sm font-semibold">SIDEBAR_BOTTOM_PLACEHOLDER_TEXT</span>
                <a href="javascript:void(0)" class="block mt-px text-white-600 text-xs">SIDEBAR_BOTTOM_SUBTEXT_PLACEHOLDER_TEXT</a>
              </div>
            </div>
          </div>
        </div>
  ...
  data() {
    return {
      navigation: [
        {
          ...
          name: 'SIDEBAR_NAVIGATION_PLACEHOLDER_TEXT_1',
        ...
        {
          href: 'javascript:void(0)',
          name: 'SIDEBAR_NAVIGATION_PLACEHOLDER_TEXT_2',
      ...
      navsFooter: [
        {
          href: 'javascript:void(0)',
          name: 'SIDEBAR_FOOTER_PLACEHOLDER_TEXT_1',
          icon: `<svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' strokeWidth='1.5' stroke='currentColor' class='w-5 h-5'>\n            <path stroke-linecap='round' stroke-linejoin='round' d='M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 1.827v.75M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9 5.25h.008v.008H12v-.008z' />\n          </svg>`,
        },
        {
          href: 'javascript:void(0)',
          name: 'SIDEBAR_FOOTER_PLACEHOLDER_TEXT_2',
        ...
        {
          href: 'javascript:void(0)',
          name: 'SIDEBAR_FOOTER_PLACEHOLDER_TEXT_3',
